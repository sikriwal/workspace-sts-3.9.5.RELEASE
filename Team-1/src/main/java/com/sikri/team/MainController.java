...
public class MainController {
	...
	public @ResponseBody List<ChildTeam> getcTeamByName(@PathVariable String name)
	{
		return childTeamDao.findAll();
	}
	
	@RequestMapping("/pteam/{name}")
	public @ResponseBody List<ChildTeam> getcTeamByParentTeamName(@PathVariable String name)
	{
		return (List<ChildTeam>)childTeamDao.findByTeam(null);
	}
}
